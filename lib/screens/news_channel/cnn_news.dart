...
class CnnNews extends StatefulWidget {
  const CnnNews({super.key});

  @override
  State<CnnNews> createState() => _CnnNewsState();
}

class _CnnNewsState extends State<CnnNews> {
  Future<List<Article>> cnnNews() async {
    final response = await http.get(Uri.parse(
        'https://newsapi.org/v2/top-headlines?sources=cnn&apiKey=577e690eecc7494487f8d1ca921485c8'));
