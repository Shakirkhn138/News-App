...
class Article {
  ...
  String get formattedDate {
    try {
      DateTime date = DateTime.parse(publishAt);
...
class AlJazeeraNews extends StatefulWidget {
  const AlJazeeraNews({super.key});

  @override
  State<AlJazeeraNews> createState() => _AlJazeeraNewsState();
}

class _AlJazeeraNewsState extends State<AlJazeeraNews> {
  Future<List<Article>> alJazeera() async {
    final response = await http.get(Uri.parse(
        'https://newsapi.org/v2/top-headlines?sources=al-jazeera-english&apiKey=577e690eecc7494487f8d1ca921485c8'));
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to fetch Al-Jazeera news');
    }
  }
